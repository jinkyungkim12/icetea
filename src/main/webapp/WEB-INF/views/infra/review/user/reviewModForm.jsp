                ...
                <div class="row">
                  <div class="col-12 mb-6">
                    ...
                    <div class="rating-form">
                    	...
                    	<div class="star-rating justify-content-center reviewStar2">
						  <i class="fa-solid fa-star"></i>
						  <i class="fa-solid fa-star"></i>
						  <i class="fa-solid fa-star"></i>
						  <i class="fa-solid fa-star"></i>
                  ...
                  <div class="col-12" style="margin-top: 1rem;">
                    ...
                    <div class="form-group">
                      ...
                      <input class="form-control form-control-sm" id="reviewName" type="text" placeholder="" value="kangsong" required="">
                    </div>
                  ...
                  <div class="col-12" style="margin-top: 1.5rem;">
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control form-control-sm" id="reviewText" rows="5" placeholder="" required="">이모티콘 수익화 성공했습니다!</textarea>
                    </div>
                  ...
                  <div class="col-12 text-center" style="margin-top: 3rem;">
                    ...
                    <!-- Button -->
                    <a class="btn btn-outline-dark" type="button" href="#">후기 수정하기</a>
