	...
	<div class="container" id="containerFont">
		...
		<div class="row" style="margin-top: 1rem;">
			<label class="form-label"><b>쿠폰</b></label>
	   		<div class="row">
		   		<div class="col-9">
		   			<input type="text" class="form-control" value="0원" placeholder="">
		   		</div>
		   		<div class="col-3">
		...
		<div class="row" style="margin-top: 1rem;">
			...
			<div class="col-2 text-end"><span><b>319,400원</b></span></div>
		</div>
		<div class="row" style="margin-top: 1rem;">
		...
		<div class="row" style="margin-top: 1rem;">
			...
			<div class="col-2 text-end" id="DCcoupon"><span> - 10,000원</span></div>
		</div>
		<div class="row justify-content-end" style="margin-top: 1rem;">5개월 할부 시 월 51,200원</div>
		<div class="row" style="margin-top: 1rem;">
			<div class="col-2" id="finalPrice"><h5><b>최종 가격</b></h5></div>
			<div class="col-8" id="mip">무이자 할부 가능</div>
			<div class="col-2 text-end" id="finalPrice"><span><h5><b>256,000원</b></h5></span></div>
		</div>
		<hr class="hrstyle">
		...
		<div class="row justify-content-center">
			<a type="button" href="/order/orderViewFormOther" role="button" class="btn btn-danger" id="buttonPrice">결제 하기</a>
		</div>	
	</div>
