		...
		<table class="table table-hover" id="minus">
			...
			<tbody>
				...
				<tr>
					...
					<th scope="row">2</th>
					<td><a class="aaa" href="#">토익독학길잡이</a></td>
					<td>오늘의 특가! TIME DEAL</td>
					<td>국내 1위 토익..</td>
					<td>20%</td>
					<td>250,000원</td>
					<td>5개월</td>
					<td>9개 챕터, 27개 세부강의</td>
					<td>Y</td>
					<td>N</td>
					<td>Y</td>
					<td>N</td>
					<td>2022.04.05 15:00:05</td>
					<td>2022.04.05 15:00:05</td>
				</tr>
				<tr>
					<td>
					...
					<th scope="row">4</th>
					<td><a class="aaa" href="#">근영쌤</a></td>
					<td>MD 추천 클래스</td>
					<td>영어 회화 1위..</td>
					<td>20%</td>
					<td>200,000원</td>
					<td>5개월</td>
					<td>8개 챕터, 34개 세부강의</td>
					<td>Y</td>
					<td>Y</td>
					<td>N</td>
					<td>N</td>
					<td>2021.07.05 14:00:05</td>
					<td>2021.07.05 14:00:05</td>
				</tr>
				<tr>
					<td>
					...
					<th scope="row">5</th>
					<td><a class="aaa" href="#">아로스</a></td>
					<td>오늘의 특가! TIME DEAL</td>
					<td>하루 1시간 ..</td>
					<td>30%</td>
					<td>250,000원</td>
					<td>5개월</td>
					<td>9개 챕터, 35개 세부강의</td>
					<td>Y</td>
					<td>Y</td>
					<td>Y</td>
					<td>N</td>
					<td>2022.09.09 21:00:50</td>
					<td>2022.09.09 21:00:50</td>
				</tr>
				<tr>
					<td>
					...
					<th scope="row">6</th>
					<td><a class="aaa" href="#">banzisu</a></td>
					<td>오늘의 특가! TIME DEAL</td>
					<td>일상에 따뜻한..</td>
					<td>40%</td>
					<td>300,000원</td>
					<td>5개월</td>
					<td>11개 챕터, 53개 세부강의</td>
					<td>Y</td>
					<td>Y</td>
					<td>Y</td>
					<td>N</td>
