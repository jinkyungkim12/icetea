package com.class101project.modules.test;
...
public class DTOtest {
	...
	private Integer ifmmRecommenderSeq;
	...
	public Integer getIfmmRecommenderSeq() {
		return ifmmRecommenderSeq;
	}
	public void setIfmmRecommenderSeq(Integer ifmmRecommenderSeq) {
	...
	public Integer getModeDeviceCd() {
		return modeDeviceCd;
	}
	public void setModeDeviceCd(Integer modeDeviceCd) {
		this.modeDeviceCd = modeDeviceCd;
	}
